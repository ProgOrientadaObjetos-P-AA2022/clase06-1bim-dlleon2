        ...
        if (opcion == 1) {
            ...
            if (opcion == 2) {
                ...
                if (opcion == 4) {
                    ...
                    // se procede a crear el objeto, haciendo uso del constructor
                    // que corresponda.
                    Hospital hosp4 = new Hospital(nombreHospital, 
                            ciudadDeHospital, numeroDeCamas, 
                            numeroDeDoctores,
                            presupuestoAnio);
                    ...
                    System.out.printf("Datos Hospital\n"
                            ...
                            + "Número de doctores: %d\n"
                            + "Presupuesto anual: %.2f\n",
                            hosp4.obtenerNombreHospital(),
                            hosp4.obtenerCiudadHospital(),
                            hosp4.obtenerNumeroCamas(),
                            hosp4.obtenerNumeroDoctores(),
                            hosp4.obtenerPresupuestoAnual());
